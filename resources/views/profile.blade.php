...
@section('title','24h - Thông tin tài khoản')
@section('content')
            ...
            <div class="row">
                ...
                <form action="{{ route('update') }}" method="post"  enctype="multipart/form-data" >
                    ...
                    <div class="col-md-4 col-sm-6 col-xs-12">
                        ...
                        @php
    $imageUrl = auth()->user()->image ? asset('storage/' . auth()->user()->image->path) : asset('storage/placeholders/user_placeholder.jpg');
@endphp

<img style="border: 4px solid #979993; border-radius: 50%; margin: auto; background-size: cover; width: 180px; height: 180px; background-image: url('{{ $imageUrl }}')" alt="">
                            <div class="mb-3">
