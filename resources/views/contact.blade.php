						...
						<div class="row">
							<div class="col-md-12">
								<div class="contact-info-wrap-flex">
									<div class="con-info">
										<p><span><i class="icon-location-2"></i></span> 828 Sư Vạn Hạnh, <br>Quận 10, TP. Hồ Chí Minh</p>
									</div>
									<div class="con-info">
										<p><span><i class="icon-phone3"></i></span> <a href="tel://1234567920">(+84) 947 384 573</a></p>
									</div>
									<div class="con-info">
										<p><span><i class="icon-paperplane"></i></span> <a href="mailto:huflitnews@gmail.com">vdknews@gmail.com</a></p>
									</div>
									<div class="con-info">
										<p><span><i class="icon-globe"></i></span> <a href="#">vdk.nam.vn</a></p>
									</div>
								</div>
							</div>
						</div>
