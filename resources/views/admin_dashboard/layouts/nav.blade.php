...
<div class="sidebar-wrapper" data-simplebar="true">
            <div class="sidebar-header">
                <div>
                    <img src="{{ asset('kcnew/frontend/img/logo24h.png') }}" class="logo-icon" alt="logo icon">
                </div>
                <div>
                    <h4 style="color: #00b249" class="logo-text">Bản tin 24h</h4>
                </div>
