...
@section('title','24h - Trang Tin Tức Việt Nam')
								...
								<div class="row">
									<div class="col-sm-12">
										<a
											...
											<img src="{{ asset('kcnew/frontend/img/huflit.png') }}" alt="">
										</a>
									</div>
								</div>
							</div>
						...
						<div class="widget">
							...
							<div class="ad--widget">
								<div class="row">
									<div class="col-sm-6">
										<a href="javascript:;">
											<img src="{{ asset('kcnew/frontend/img/huflit1.png') }}"
												alt="">
										</a>
									</div>
...
<div class="colorlib-blog" style="display: none !important">
	<div class="container">
		<div class="row">
			...
			<!-- <a href="{{ route('posts.show', ['post' => $post->id]) }}" class="blog-img" style="background-image: url({{ asset($post->image ? 'storage/' . $post->image->path : 'storage/placeholders/placeholder-image.png') }});"></a> -->
				<div class="text">
