							...
							@foreach($post->comments as $comment)
                                <li>
                                   ...
                                   <div class="comment--img float--left">
                                    <img src="{{ $comment->user->image ? asset('storage/' . $comment->user->image->path) : asset('storage/placeholders/user_placeholder.jpg') }}" alt="{{ $comment->user->name }}" style="border-radius: 50%; width: 68px; height: 68px;">
                                        </div>
                        ...
                        <div class="comment--form pd--30-0">
                            ...
                            <div class="comment-respond">
                                ...
                                <form onsubmit="return false;" autocomplete="off" method="POST" >
                                    ...
                                    <small style="color: red; font-size: 20px;" class="comment_error"> </small>
